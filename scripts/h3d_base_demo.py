...
class Horde3DWidget(QOpenGLWidget):
    ...
    def initializeGL(self):
        self.horde = pyhorde.Engine(width=512, height=512, GLVersion=2)
    ...
    def resizeGL(self, width, height):
        ...
        if horde is not None:
            horde.h3dSetNodeParamI(cam, pyhorde.h3dCamera.ViewportXI, 0)
            horde.h3dSetNodeParamI(cam, pyhorde.h3dCamera.ViewportYI, 0)
            horde.h3dSetNodeParamI(cam, pyhorde.h3dCamera.ViewportWidthI, width)
            horde.h3dSetNodeParamI(cam, pyhorde.h3dCamera.ViewportHeightI, height)
            horde.h3dSetNodeParamI(cam, pyhorde.h3dCamera.OccCullingI, 0)
    ...
    def setupHorde(self, h, width, height):
        ...
        # Add the platform.
        base = h.h3dAddNode(pyhorde.h3dRootNode, self.resources['base'])
        h.h3dSetNodeTransform(base, 0, 1000, 0, 0, 0, 0, 1, 1, 1)
        del base

        # Add the skybox to the scene and scale it.
        s = int(0.9 * 5000 / 1.7)
        skybox = h.h3dAddNode(pyhorde.h3dRootNode, self.resources['sky'])
        ...
        # Add the camera.
        cam = h.h3dAddCameraNode(pyhorde.h3dRootNode, 'Camera', self.resources['shader'])
